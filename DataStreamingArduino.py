...
def daq_stream(arduino, n_data=100, delay=20):
    ...
    return pd.DataFrame({'time (ms)': time_ms, 'signal 0': signal0, 'signal 1': signal1, 'signal 2': signal2, 'signal 3': signal3})
...
def main():
    ...
    while True:
        if keyboard.is_pressed('p'):
            ...
            arduino.flush()
            df = daq_stream(arduino, n_data=1000, delay=10) # should 1000 datapoints over 10 seconds?
